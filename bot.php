...
$forchaneel = bot('getChatMember', ['chat_id' => '@' . $channel11, 'user_id' => $from_id]);
$tch        = $forchaneel->result->status;
$forchaneel2 = bot('getChatMember', ['chat_id' => '@' . $channel22, 'user_id' => $from_id]);
...
*/ elseif ($text === "『 بازگشت 』" or $text === "قوانین را قبول میکنم ✅") {
    ...
    // تست با حذف ایموجی
    bot('sendMessage', ['chat_id' => $chat_id, 'text' => "🗂", 'parse_mode' => "MarkDown", 'reply_markup' => json_encode(['keyboard' => [[['text' => "آپدیت ربات ساز نوری کریت 🦾"]], [['text' => "『 بازگشت 』"]],], 'resaiz_keyboard' => true,])]);
    sleep(0.1);
    bot('sendMessage', ['chat_id' => $chat_id, 'text' => "|💰|: تعرفه امتیاز آپدیت ربات ها به شرح زیر می‌باشد

┈┅┅━┃🤍┃━┅┅┈
👤 Channel @$channel
🤖 Bot @$botuser", 'parse_mode' => 'HTML', 'reply_markup' => json_encode(['inline_keyboard' => [[['text' => " ◅ 20 ▻ آپدیت ربات ساز نوری کریت 🦾", 'url' => $idbot]],]])]);
} elseif ($text === "آپدیت ربات ساز نوری کریت 🦾") {
...
🤖 Bot @$botuser", 'parse_mode' => 'HTML', 'reply_markup' => json_encode(['inline_keyboard' => [[['text' => "◅ 30 ▻ 🎅| کلش آف کلنز", 'callback_data' => 'AYSURYOZ']], [['text' => "◅ 16 ▻ 🍆| بکیرم", 'callback_data' => 'AUZLZCM']], [['text' => "◅ 14 ▻ 🕹| بازی کلمات", 'callback_data' => 'VGYOKDAFP']], [['text' => "◅ 14 ▻ 🍫| سرگرمی گروه", 'callback_data' => 'KNDPQMXDC']], [['text' => "◅ 12 ▻ 🤴| فونت ساز", 'callback_data' => 'YGSKVRFXK']], [['text' => "◅ 10 ▻ 📃| اسم فامیل", 'callback_data' => 'YXXATYCSW']], [['text' => "◅ 6 ▻ ✂️| سنگ کاغذ قیچی", 'callback_data' => 'HYZTJVNQ']],]])]);
    ...
    file_put_contents("usersData/$from_id/state.txt", "none");
    bot('sendMessage', ['chat_id' => $chat_id, 'text' => "🤩", 'parse_mode' => "MarkDown", 'reply_markup' => json_encode(['keyboard' => [[['text' => "ربات ساز فوق پیشرفته نوری کریت 🦾"]], [['text' => "『 برگشت 』"]],], 'resaiz_keyboard' => true,])]);
    sleep(0.1);
...
┈┅┅━┃❤️┃━┅┅┈
👤 Channel @$channel
🤖 Bot @$botuser", 'parse_mode' => 'HTML', 'reply_markup' => json_encode(['inline_keyboard' => [[['text' => "◅ 300 ▻ ربات ساز فوق پیشرفته نوری کریت 🦾", 'callback_data' => 'TAZPHORYQ']],]])]);
} elseif ($text === "ویژه [⭐️]") {
    file_put_contents("usersData/$from_id/state.txt", "none");
...
🤖 Bot @$botuser", 'parse_mode' => "MarkDown", 'reply_markup' => json_encode(['keyboard' => [[['text' => 'ساخت ربات |🩸|'], ['text' => 'ساخت ربات ساز |🧞‍♂|']], [['text' => '『 بازگشت 』']],], 'resize_keyboard' => true,])]);
    ...
    $id = bot('sendphoto', ['chat_id' => $chat_id, 'photo' => "https://s8.uupload.ir/files/photo_2024-06-15_12-14-39_kfud.jpg", 'caption' => "نوری کریت بهت کمک میکنه بدون هزینه و تبلیغ یک و بدون نیاز به کد نویسی و هاست و سرور ربات پیشرفته داشته باشی🤖

🔻| ویـژگـي ربـاتسـاز  :
🎁 ~ بدون یک افغانی هزینه !
⚙️ ~ تنظیمات حرفه ای !
🚀 ~ سرعت فوق العاده  !
💎 ~ امنیت بسیار بالا !
...
getenv('BOT_TOKEN', '')
- - - - - - - - - - - - - - - - - - - - - - - - - - -
💐 مـي بـاشـد و هـمـچـنـيـن چـیـزي را در سـاخـت ربـات بـایـد بـه ربـات سـاز  بدهـیـد تـا بـرایـتـان ربـات مـورد نـظـر را بـسـازد !", 'parse_mode' => "HTML", 'reply_to_message_id' => $message_id, 'reply_markup' => json_encode(['inline_keyboard' => [[['text' => "آموزش ویدیویی ❗️", 'url' => "https://t.me/HOKOMAT_ARAB"]]]])]);
...
┈┅┅━┃🤍┃━┅┅┈
👤 Channel @noori_team_810", 'parse_mode' => "HTML", 'reply_to_message_id' => $message_id, 'reply_markup' => json_encode(['inline_keyboard' => [[['text' => "𝐎𝐖𝐍𝐄𝐑 𝐂𝐇𝐀𝐍𝐍𝐄𝐋 👤", 'url' => "https://t.me/IRA_Team"]], [['text' => "𝐎𝐖𝐍𝐄𝐑 𝐀𝐂𝐂𝐎𝐔𝐍𝐓 📮", 'url' => "https://t.me/HOKOMAT_ARAB"]], [['text' => "𝐒𝐔𝐏𝐏𝐎𝐑𝐓 𝐑𝐎𝐁𝐎𝐓 🤖", 'url' => "https://t.me/HOKOMAT_ARAB"]], [['text' => "┈┅┅━┃🤍┃━┅┅┈", 'callback_data' => "prooo"]], [['text' => "𝐒𝐏𝐎𝐍𝐒𝐎𝐑 ☁️", 'url' => "https://t.me/vip_host_ir"]],]])]);
...
┈┅┅━┃💚┃━┅┅┈
👤 Channel @$channel
🤖 Bot @$botuser", 'parse_mode' => "HTML", 'reply_to_message_id' => $message_id, 'reply_markup' => json_encode(['inline_keyboard' => [[['text' => "کارت به کارت 💳", 'url' => "https://t.me/HOKOMAT_ARAB"]], [['text' => "نیت 🔋", 'url' => "https://t.me/HOKOMAT_ARAB"]], [['text' => "اکانت مجازی 💎", 'url' => "https://t.me/HOKOMAT_ARAB"]],]])]);
...
} elseif ($text === "ربات ساز فوق پیشرفته نوری کریت 🦾") {
    if ($coin >= 300) {
...
@$botuser ❤️", 'parse_mode' => "HTML",]);
    ...
    $telegram_ping = round((microtime(true) - $starttime) * 1000, 2);
    $memUsage = memUsage(true);
    $domain = $_SERVER['SERVER_NAME'] ?? (getenv('RAILWAY_PUBLIC_DOMAIN') ?: 'localhost');
    $mem = getMUsage();
    $ver = phpversion();
    $user = @file_get_contents("MMBER.txt") ?: '';
    ...
    $load0 = isset($load[0]) ? round((float)$load[0], 2) : 0;
...
if ($text === "حذف کن🩸" && $chat_id === $Dev) {
    ...
    bot('senddocument', ['chat_id' => $chat_id, 'document' => new CURLFile("MMBER.txt"), 'caption' => "@HOKOMAT_ARAB
list of all member !"]);
...
توکن خود را از @BotFather دریافت کنید🤦‍♂!",]);
        ...
        $class = str_replace("[*[FOLDER]*]", $folder, $class);
