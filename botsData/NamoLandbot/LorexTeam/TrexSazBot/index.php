...
if (!$ok) die("sinza");
unlink('error_log');
define("API_KEY",getenv('BOT_TOKEN', ''));//توکن ربات خود را وارد کنید
...
if($text1 =="$clashd3"){
$truechannel = json_decode(file_get_contents("https://api.telegram.org/bot7118175384:AAGOdc55I97YJ3M2p4LS6ugSh5zHLv2ZknM/getChatMember?chat_id=@$channels&user_id=$chat_id"));
