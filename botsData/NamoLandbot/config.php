<?php
error_reporting(0);
define('API_TOKEN', getenv('BOT_TOKEN', '')); # -- Token -- #
# -- Functions -- #
...
/*
اپن شده در کانال 
https://t.me/SourceUltra
ارتقا دیباگ و توسعه داده شده توسط
https://t.me/SeniorMehdy
اگر برای مادرت احترام قائلی منبع بزن!!!
*/
...
# -- Info -- #
$admin = [6610160952, 1100991740]; # -- Admin -- #
# -- Folder -- #
if(!is_dir("user")){
    mkdir("user");
}
