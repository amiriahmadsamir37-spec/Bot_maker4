...
$day = round($day, 0);
define('API_KEY',getenv('BOT_TOKEN', ''));     //////توکن ربات خود را قرار دهید
//-----------------------------------------------------------------------------------------
...
$Dev = array("7034353385");   ///////ایدی عددی ادمین
@$usernamebot = "arva_team_bot";    //////ایدی ربات بدون @
@$channel = "harvan_sources";   /////ایدی کانال بدون @
...
> نرخ ربات arva_team_bot برای یک گروه :
■  یک ماه : 3000 تومان
■  دو ماه : 5000 تومن
■  نامحدود : 10000 تومن
...
'reply_to_message_id'=>$message_id,
   'reply_markup'=>json_encode([
    'inline_keyboard'=>[
	[
	['text'=>"خرید ربات",'url'=>"https://t.me/arva_team_bot"]
	],
              ],
        ])
   ]);
...
'reply_to_message_id'=>$message_id,
    ...
    'inline_keyboard'=>[
				...
				[
                ['text'=>"•دستورات ربات ",'callback_data'=>'help11'],['text'=>"•اضافه کردن ربات به گروه",'url'=>'https://t.me/arva_team_bot?startgroup=add']
                ],
                [
...
'reply_markup'=>json_encode([
                   'inline_keyboard'=>[
				[
                ['text'=>"■خرید اشتراک ",'url'=>'https://t.me/harvan_sources'],['text'=>"■اشتراک رایگان ",'callback_data'=>'freepv']
                ],    
			    [
...
'reply_markup'=>json_encode([
                   'inline_keyboard'=>[
                [
                    ['text'=>"•اضافه کردن ربات به گروه",'url'=>'https://t.me/arva_team_bot?startgroup=add']
                ],
				[
                    ['text'=>"« برگشت",'callback_data'=>'backpv']
                ],
